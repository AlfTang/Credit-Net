...
%cumprod([1, D(1:end - 1)]) produces 1 x D matrix
%I(:) produces I x 1 matrix
%repmat(I(:) - 1, 1, length(D)) produces I x D matrix
%repmat(cumprod([1, D(1:end - 1)]), length(I), 1) produces I x D matrix
